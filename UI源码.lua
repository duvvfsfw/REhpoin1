...
function Ripple(obj)
	...
	spawn(function()
		...
		Ripple.ImageColor3 = Color3.fromRGB(0, 255, 255)
...
if theme == 'dark' then
    ...
    Background = Color3.fromRGB(25, 25, 25)
    zyColor= Color3.fromRGB(25, 25, 25)
    beijingColor = Color3.fromRGB(0, 255, 255)
    DTTransparency = 1.0
end
      ...
      SB.Name = "SB"
      SB.Parent = Main
      SB.BackgroundColor3 = Color3.fromRGB(0, 255, 255)
      ...
      Side.Name = "Side"
      Side.Parent = SB
      Side.BackgroundColor3 = Color3.fromRGB(0, 255, 255)
      Side.BorderColor3 = Color3.fromRGB(0, 255, 255)
      ...
      TabBtns.Parent = Side
      TabBtns.Active = true
      TabBtns.BackgroundColor3 = Color3.fromRGB(0, 255, 255)
      ...
      ScriptTitle.BackgroundColor3 = Color3.fromRGB(0, 255, 255)
    ...
    coroutine.wrap(NPLHKB_fake_script)()
      ...
      function window.Tab(window, name, icon)
        ...
        TabText.BackgroundColor3 = Color3.fromRGB(0, 255, 255)
        ...
        function tab.section(tab, name, TabVal)
          ...
          SectionText.BackgroundColor3 = Color3.fromRGB(0, 255, 255)
          SectionText.BackgroundTransparency = 1.000
          SectionText.Position = UDim2.new(0.0887396261, 0, 0, 0)
          SectionText.Size = UDim2.new(0, 401, 0, 36)
          SectionText.Font = Enum.Font.GothamSemibold
          SectionText.Text = name
          SectionText.TextColor3 = Color3.fromRGB(0, 255, 255)
          ...
          Objs.Name = "Objs"
          Objs.Parent = Section
          Objs.BackgroundColor3 = Color3.fromRGB(0, 255, 255)
          ...
          function section.Button(section, text, callback)
            ...
            BtnModule.BackgroundColor3 = Color3.fromRGB(0, 255, 255)
            BtnModule.BackgroundTransparency = 0.6
        ...
        function section:Label(text)
          ...
          LabelModule.BackgroundColor3 = Color3.fromRGB(0, 255, 255)
          ...
          function section.Toggle(section, text, flag, enabled, callback)
            ...
            ToggleModule.BackgroundTransparency = 0.6
            ...
            local funcs = {
              SetState = function(self, state)
                ...
                services.TweenService:Create(ToggleSwitch, TweenInfo.new(0.2), {Position = UDim2.new(0, (state and ToggleSwitch.Size.X.Offset / 2 or 0), 0, 0), BackgroundColor3 = (state and Color3.fromRGB(0, 255, 255) or beijingColor)}):Play()
          ...
          function section.Keybind(section, text, default, callback)
            ...
            KeybindModule.BackgroundColor3 = Color3.fromRGB(0, 255, 255)
            ...
            KeybindBtn.TextColor3 = Color3.fromRGB(0, 255, 255)
            ...
            KeybindValue.TextColor3 = Color3.fromRGB(0, 255, 255)
          ...
          function section.Textbox(section, text, flag, default, callback)
            ...
            TextboxModule.BackgroundColor3 = Color3.fromRGB(0, 255, 255)
            ...
            TextboxBack.TextColor3 = Color3.fromRGB(0, 255, 255)
            ...
            BoxBG.Text = ""
            BoxBG.TextColor3 = Color3.fromRGB(0, 255, 255)
          ...
          function section.Slider(section, text, flag, default, min, max, precise, callback)
            ...
            SliderModule.BackgroundColor3 = Color3.fromRGB(0, 255, 255)
            ...
            SliderBack.TextColor3 = Color3.fromRGB(0, 255, 255)
            ...
            SliderValBG.Text = ""
            SliderValBG.TextColor3 = Color3.fromRGB(0, 255, 255)
            ...
            MinSlider.BackgroundColor3 = Color3.fromRGB(0, 255, 255)
            ...
            MinSlider.Text = "-"
            MinSlider.TextColor3 = Color3.fromRGB(0, 255, 255)
            ...
            AddSlider.BackgroundColor3 = Color3.fromRGB(0, 255, 255)
            ...
            AddSlider.Text = "+"
            AddSlider.TextColor3 = Color3.fromRGB(0, 255, 255)
          ...
          function section.Dropdown(section, text, flag, options, callback)
            ...
            DropdownModule.BackgroundColor3 = Color3.fromRGB(0, 255, 255)
            ...
            DropdownTop.Text = ""
            DropdownTop.TextColor3 = Color3.fromRGB(0, 255, 255)
            ...
            DropdownOpen.BackgroundColor3 = Color3.fromRGB(0, 255, 255)
            ...
            DropdownOpen.Text = "+"
            DropdownOpen.TextColor3 = Color3.fromRGB(0, 255, 255)
            DropdownOpen.TextSize = 24.000
            DropdownOpen.TextWrapped = true
            
            DropdownText.Name = "DropdownText"
            DropdownText.Parent = DropdownTop
            DropdownText.BackgroundColor3 = Color3.fromRGB(0, 255, 255)
            DropdownText.BackgroundTransparency = 1.000
            DropdownText.BorderSizePixel = 0
            DropdownText.Position = UDim2.new(0.0373831764, 0, 0, 0)
            DropdownText.Size = UDim2.new(0, 184, 0, 38)
            DropdownText.Font = Enum.Font.GothamSemibold
            DropdownText.PlaceholderColor3 = Color3.fromRGB(0, 255, 255)
            DropdownText.PlaceholderText = text
            DropdownText.BackgroundTransparency = DTTransparency
            DropdownText.Text = ""
            DropdownText.TextColor3 = Color3.fromRGB(0, 255, 255)
